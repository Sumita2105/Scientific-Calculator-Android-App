...
public class MainActivity extends AppCompatActivity {
    ...
    @SuppressLint("SetTextI18n")
    public void btn_sinh(View view) {
        sign = "sinh";
        user_input.setText(null);
        has_Dot = false;
        sign_Box.setText("sinh");
    }

    @SuppressLint("SetTextI18n")
    public void btn_cosh(View view) {
        sign = "cosh";
        user_input.setText(null);
        has_Dot = false;
        sign_Box.setText("cosh(");
    }

    @SuppressLint("SetTextI18n")
    public void btn_tanh(View view) {
        sign = "tanh";
        user_input.setText(null);
        has_Dot = false;
        sign_Box.setText("tanh");
    }
        ...
        if (sign == null) {
            ...
            switch (sign) {
                ...
                case "sinh":
                    val_1 = user_input.getText().toString();
                    num1 = Double.parseDouble((val_1));
                    user_input.setText(Math.sinh(num1) + "");
                    sign = null;
                    sign_Box.setText(null);
                    break;
                ...
                case "cosh":
                    val_1 = user_input.getText().toString();
                    num1 = Double.parseDouble((val_1));
                    user_input.setText(Math.cosh(num1) + "");
                    sign = null;
                    sign_Box.setText(null);
                    break;
                ...
                case "tanh":
                    val_1 = user_input.getText().toString();
                    num1 = Double.parseDouble((val_1));
                    user_input.setText(Math.tanh(num1) + "");
                    sign = null;
                    sign_Box.setText(null);
                    break;

                case "pi":
                    user_input.setText(Math.PI+ "");
                    sign = null;
                    sign_Box.setText(null);
                    break;
                ...
                case "e":
                    val_1 = user_input.getText().toString();
                    num1 = Double.parseDouble((val_1));
                    user_input.setText(Math.exp(num1)+ "");
                    sign = null;
                    sign_Box.setText(null);
                    break;
